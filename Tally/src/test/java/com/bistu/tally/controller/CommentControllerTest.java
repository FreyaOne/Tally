...
public class CommentControllerTest {
	...
	@Test
	@DisplayName("测试CommentController的POST方法")
	public void testPost() throws Exception {
		CommentBean bean = new CommentBean();
		bean.setUserId((long) 1);
		bean.setCommentContent("a test");
//		bean.setSocialId((long)1);
	...
	@Test
	@DisplayName("测试CommentController的delete方法")
	public void testDetele() throws Exception {
		MvcResult mvcResult = mockMvc.perform(
				delete("/comments").accept(MediaType.APPLICATION_JSON)).andReturn();
		System.out.println(mvcResult.getResponse().getContentAsString());
